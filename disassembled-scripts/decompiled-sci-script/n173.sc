...
(instance timer3A of Script
  ...
  (method (changeState newState)
    (switch (= state newState)
      (0
        (cond
          ((== (= local3 (Random 1 2)) 2) (archer2 setScript: 0 view: 115 cel: 0 setCycle: End self))
          ((== local3 1)
            (archer
              setScript: 0
              view: 115
...
(instance musicScript of Script
  ...
  (method (cue)
    (switch (gRgnMusic prevSignal?)
      (-1)
      (1)
      (2 (lancer2 setScript: timer0A))
      (3 (outlaw2 setScript: timer1))
      (4 (victim2 setScript: timer2))
      (5 (outlaw setScript: timer2A))
      (6
        (lancer3 setScript: timer3)
        (victim2 setScript: timer3A)
      )
      (7 (knave setScript: timer4))
      (8 (robin setScript: timer5))
      (9 (robin setScript: timer6))
    )
  )
)
