...
(procedure (proc940_0 param1 &tmp temp0 newDialog newDText newDTextNsRight temp4 newDTextNsBottom temp6 temp7 temp8 temp9 temp10 temp11 temp12 temp13 temp14)
  (= temp10 (= temp11 -1))
  (= newDTextNsRight
  ...
  (= temp12 0)
  (= temp14 0)
  ((= newDialog (Dialog new:)) window: global38)
  (= temp0 0)
  (while (< temp0 argc)
