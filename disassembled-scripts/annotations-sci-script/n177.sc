...
(instance willCas of Rm
  ...
  (method (init)
    (proc958_0 128 80 111 114 115 394 393)
    (proc958_0 132 124)
    (Load rsPIC 390)
    (robin init: stopUpd:)
    (lilj init: stopUpd:)
...
(instance timer0 of Script
  ...
  (method (changeState newState)
    (switch (= state newState)
      (0
        (if (== client knave2) (= local1 4) else (= local1 5))
        (= ticks 6)
      )
      (1
...
(instance timer5 of Script
  ...
  (method (changeState newState)
    (switch (= state newState)
      (0 (muchm x: 58) (= ticks 6))
      (1 (muchm x: 62) (= ticks 6))
      (2
        (muchm x: 66 stopUpd:)
        (= ticks 6)
      )
...
(instance musicScriptBad of Script
  ...
  (method (cue)
    (switch (gRgnMusic prevSignal?)
      ...
      (3 (knave setScript: timer1))
      (4 (victim setScript: timer2A))
      (5 (knave4 setScript: timer3))
      (6
        (if (== local7 2)
          (knave2 setScript: timer0)
        else
...
(instance musicScriptTwo of Script
  ...
  (method (cue)
    (switch (gRgnMusic prevSignal?)
      ...
      (3
        (switch local7
          (1 (knave4 setScript: timer3))
          (2 (knave2 setScript: timer0))
          (else
            (knave3 setScript: timer0)
          )
        )
