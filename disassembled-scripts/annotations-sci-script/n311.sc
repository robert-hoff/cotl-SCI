...
(procedure (proc311_1 param1 param2 param3 &tmp temp0 temp1)
	...
	(if (< (= temp0 (+ param1 param2)) 1) (= temp0 6))
	(if (> temp0 6) (= temp0 1))
	(if (== (= temp1 [local4 param1]) param1) (= temp1 0))
	(if (localproc_0305 param1 temp0 temp1)
		(= local0 0)
		(Fair setScript: sWalkOut 0 param3)
	else
		(param3
			init: (- param2) param1 (localproc_03e1 param1) [local135 param1] 0
		)
	)
)

(procedure (proc311_3 &tmp temp0)
	(= local2 (- (/ global11 10) 27))
	(if (< (gEgo y?) 99) (= local2 [local4 local2]))
		...
		(if
			...
			((ScriptID (+ 312 temp0))
				init:
					[local142 temp0]
					[global120 local0]
					(localproc_03e1 [global120 local0])
...
(procedure (proc311_4 param1 &tmp temp0)
	...
	(if (== (- (Random 1 5) 1) 3)
		(if (== global11 300) else (== global11 290))
		(param1
			signal: 16400
			priority: (if (== global11 290) 4 else 8)
...
(procedure (localproc_0305 param1 param2 param3 &tmp temp0 temp1)
	...
	(while (< temp0 3)
		(if (== [global120 temp0] param1)
			(if (== param1 param3) (return 0))
			(if (== (= temp1 (- param2 param1)) -5) (= temp1 1))
			(if (== temp1 5) (= temp1 -1))
			(= param1 param2)
			(if (< (= param2 (+ param2 temp1)) 1) (= param2 6))
			(if (> param2 6) (= param2 1))
			(if (localproc_0305 param1 param2 param3)
				...
				(if
					...
					(= local0 1)
					((ScriptID (+ 312 temp0))
						init: temp1 param1 (localproc_03e1 param1) [local135 param1] 0
					)
				)
				(return 1)
			else
...
(class Fair of Rgn
	...
	(method (newRoom)
		(if (not (gEgo has: 17)) (++ global155))
		(= local0 0)
		(if (< (gEgo x?) -10) (gEgo x: -10))
		(if (> (gEgo x?) 330) (gEgo x: 330))
	)
)
...
(instance walkEm of Script
	...
	(method (changeState newState &tmp temp0 temp1 temp2 temp3)
		(switch (= state newState)
			(0
				(if (and (proc0_5 58) (> global155 50))
					(gClient west: 160 east: 160 north: 160 south: 160)
				)
				(= ticks 801)
			)
			(1
				...
				(while (< temp0 3)
					(if
						...
						(if
						(< (= temp2 (+ [global120 temp0] (Random 1 3) -2)) 1)
							(= temp2 6)
						)
						(if (> temp2 6) (= temp2 1))
						(if
							...
							(if
								...
								(= local0 1)
								((ScriptID (+ 312 temp0))
									init: temp3 temp2 (localproc_03e1 temp2) [local135 temp2] 0
								)
							)
...
(instance catWalk of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(client
					setMotion: MoveTo (if (== (client loop?) 0) 250 else 25) 84 self
				)
			)
			(1
				(client
