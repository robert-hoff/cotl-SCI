...
(procedure (proc121_0 &tmp temp0 temp1)
  ...
  (while (< temp0 4)
    ...
    ((= [local0 temp0] ((ScriptID 120 1) new:))
      view: [local4 temp1]
      loop: [local40 temp1]
      x: [local76 temp1]
      y: [local112 temp1]
      ...
      priority:
        (cond
          ((== temp1 21) 0)
          ((proc999_5 temp1 4 9 29 34) 1)
          ((proc999_5 temp1 18 31) 3)
          ((proc999_5 temp1 6 8) 4)
          ((== temp1 17) 6)
          ((proc999_5 temp1 7 11 15 19 22) 15)
          (else -1)
        )
      signal: 20496
      init:
    )
    (global10 add: [local0 temp0])
    (++ temp0)
  )
  (global10 doit:)
  (if argc
