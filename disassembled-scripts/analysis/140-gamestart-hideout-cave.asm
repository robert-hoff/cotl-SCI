...
// There are 46 strings and 470 characters
...
// this token always seems to appear in the form shown without any arguments associated to it
(said
)


// there are 20 defined local variables. Some are initialised to zero and are written to later in the code
...
(instance egoHorn of SpecialDoVerb
  ...
  318e:35 01              ldi 1
  3190:a3 00              sal local0                   // store the value of the stack to local0 (the local variable indexes by 0)
  3192:78               push1
