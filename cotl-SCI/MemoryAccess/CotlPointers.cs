namespace cotl_SCI.MemoryAccess
{
    class CotlPointers
    {
        ...
        public static int KEYQUEUE0_KEYCODE_PTR = 0x41E;
        public static int GLOBAL_CLOCK_PTR = 0x46C;

        public static int RANDOM_SEED_PTR = 0x1B1C4;

        public static int MOUSE_PRESSED_STATE_PTR = 0x1B490; // 1 or 2
        public static int CURSOR_CATEGORY = 0x1B494;
        public static int MOUSE_TIMESTAMP_PTR = 0x1B496; // takes the value of the game clock
        public static int MOUSE_CURSOR0_X_PTR = 0x1B49C;
        public static int MOUSE_CURSOR0_Y_PTR = 0x1B49A;
        public static int MOUSE_CURSOR1_X_PTR = 0x1B4A2;
        public static int MOUSE_CURSOR1_Y_PTR = 0x1B4A0;
        public static int MOUSE_BUTTON_ID_PTR = 0x1B4A4;

        public static int STACK_PTR0 = 0x1C8AC;
        public static int STACK_PTR1 = 0x1C8AE;
        public static int EVENT_CLOCK_PTR = 0x1CAEE;

        public static int ROOM_NR_PTR = 0x1D70C;
        public static int EVENT_DATA0_PTR = 0x1D71A;
